    ...
    for r in range(repeats):
        for depth in depths:
            for vv,variation in enumerate(variations):
                ...
                pk.dump(depth_effective_dimensions,open("../data/depth_effective_dimensions_pulsars_2.data","wb"))
